...
\newcommand{\tecnologias}[1]{
    \vspace{-0.5em}
    \noindent \footnotesize \textbf{\color{primaryColor}Herramientas principales:} #1 \normalsize \par % \vspace{0.8em}
}
\newcommand{\habilidades}[1]{
    \vspace{-0.5em}
    \noindent \footnotesize \textbf{\color{primaryColor}Habilidades destacadas:} #1 \normalsize \par % \vspace{0.8em}
}
...
\section{Presentación de Pósteres}
