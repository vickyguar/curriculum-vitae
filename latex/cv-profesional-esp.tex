...
\begin{experiencia}{Programa de Inteligencia Artificial en Salud, Hospital Italiano de Buenos Aires}
    \begin{rol}{Trainee en IA}{Sep 2024 -- Presente}
        \item Construcción y evaluación de un modelo de aprendizaje profundo para clasificación de imágenes clínicas.
...
\tecnologias{\textbf{Python 3.13} (PyTorch, Pandas, Numpy, Scikit-learn, Matplotlib, Seaborn, Pyplot, FastApi); \textbf{servicios de AWS} (AWS SageMaker, S3); \textbf{control de versiones} con Git, Github, Bitbucket; \textbf{seguimiento de experimentos} con Weights \& Biases (wandb); \textbf{R 4.3} (tidyverse, ggplot2, plotly, irrCAC); \textbf{Docker}.}
...
\begin{experiencia}{FICEN-UF -- Departamento de Matemática}
    ...
    \begin{rol_corto}{Ayudante Alumno}{Ago 2021 -- Presente}
        {Ayudante en las materias:
            \begin{itemize}[nosep, leftmargin=2em, label=--, itemsep=0pt, parsep=0pt, topsep=0pt, partopsep=0pt]
                \item \textbf{Cálculo I} (Cálculo en una variable).
                \item \textbf{Cálculo II} (Cálculo en varias variables).
                \item \textbf{Cálculo III} (Cálculo en variable compleja).
            \end{itemize}
        }
    \end{rol_corto}
\end{experiencia}
