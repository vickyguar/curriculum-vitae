...
\begin{experiencia}{FICEN-UF -- Departamento de Matemática}
    ...
    \begin{rol_corto}{Ayudante alumno}{Ago 2021 -- Presente}
        {Ayudannte en las materias \textbf{Cálculo I} (Cálculo en una variable), \textbf{Cálculo II} (Cálculo en varias variables) and \textbf{Calculus III} (Cálculo en variable compleja).}
    \end{rol_corto}
\end{experiencia}
